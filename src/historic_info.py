...
for ind in data.index:
    ...
    #start=1641013200&end=1647489600&appid=
    #&start=1665374400&end=1678424400&appid=
    BASE_URL = "http://api.openweathermap.org/data/2.5/air_pollution/history?lat=" + lat + "&lon=" + lon + "&start=1662696000&end=1673154000&appid=" + API_KEY
